...
public class Example2 {
    ...
    public void testFn2(){
        ...
        System.out.println("12567890416".matches("^1[0-9&&[^0124]]\\d{9}$"));

        //3、验证用户名，只能是字母开头的，数字、字母或下划线的组合 （且位数在8 ~16位）
        System.out.println("------------------------------");
        System.out.println("ad3726372_".matches("^[a-zA-Z]\\w{7,15}$"));
        //4、验证邮箱(如:zhangsan_wc@163.com) （如果是163、126邮箱的话首字母一定是字母 如果是qq邮箱的话、前面全是数字）
        System.out.println("------------------------------");
        System.out.println("zdsd@163.com".matches("^([1-9]\\d{3,10}[@]qq.com)|([a-zA-Z]\\w+[@][0-9]{3}[.][a-zA-Z]{2,3})$"));
        //5、验证年龄（100以内）

        //6、验证金额（可以有小数位） (10.34)
        System.out.println("---------------------------------");
        System.out.println("10.34".matches("^[0-9]+[.]?[0-9]{2,3}$"));
